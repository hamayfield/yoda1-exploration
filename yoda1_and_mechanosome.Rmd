...
iv.up <- yoda1mech_ishlog$log2FoldChange > 1 & iv.sig
iv.dn <- yoda1mech_ishlog$log2FoldChange < -1 & iv.sig
##Make the plot
...
##Add labels
points(log2(yoda1mech_ishlog$baseMean + 1)[iv.up], yoda1mech_ishlog$log2FoldChange[iv.up], col="forestgreen", pch=20)
points(log2(yoda1mech_ishlog$baseMean + 1)[iv.dn], yoda1mech_ishlog$log2FoldChange[iv.dn], col="steelblue", pch=20)
